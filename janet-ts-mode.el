    ...
    (concat "^"
            (regexp-opt
             '("*" "+" "-" "/"
               ...
               "odd?" "one?"
               "os/arch" "os/cd" "os/chmod" "os/clock" "os/cryptorand"
               "os/cwd" "os/date" "os/dir" "os/environ" "os/execute"
               "os/exit" "os/getenv" "os/link" "os/lstat" "os/mkdir"
               "os/mktime" "os/open" "os/perm-int" "os/perm-string"
               "os/pipe" "os/proc-kill" "os/proc-wait" "os/readlink"
               "os/realpath" "os/rename" "os/rm" "os/rmdir" "os/setenv"
               "os/shell" "os/sleep" "os/spawn" "os/stat" "os/symlink"
